...
import django_rest_api.models
from dateutil.parser import parse
from django_rest_api import rest
from django_rest_api.api_response import ApiResponse
from django_rest_api.configuration import Configuration
from django_rest_api.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(django_rest_api.models, klass)
